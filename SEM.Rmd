...
The categories of ICT mobile workers exclude self-employed because 
...
```{r}
data_fit3 <- subset(EWCS_EU28, year>=2010, select=lavNames(fit3))
lavInspect(fit3, what="nobs")
sapply(data_fit3,function(x)sum(is.na(x)))
```
